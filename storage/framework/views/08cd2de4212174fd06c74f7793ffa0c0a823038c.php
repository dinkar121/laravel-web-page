			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="<?php echo e(url('menu')); ?>">Menu</a></li>
						<li class="nav-item"><a class="nav-link" href="<?php echo e(url('about')); ?>">About</a></li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Pages</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="<?php echo e(url('reservation')); ?>">Reservation</a>
								<a class="dropdown-item" href="<?php echo e(url('stuff')); ?>">Stuff</a>
...
</html><?php /**PATH G:\laravel\resources\views/frontend/master.blade.php ENDPATH**/ ?>